    ...
    <div class="promotions">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="activity-time">Discount 20% Pizza & Dessert </div>
                            </td>
                            <td class="bg-light-gray">
        ...
        <div class="promotions-item">
            <div class="content-box">
                <img src="../assets/images/panner.jpeg" alt="">
            </div>

            <div class="description">
                <h3>Indulge in paneer perfection with our limited time offer! </h3>
                <ul>
                    <li>
                        <p>Order more than 999/- will get discount 50%</p>
                    </li>
                    <li>
        ...
        <div class="promotions-item">
            ...
            <div class="description">
                ...
                <ul>
                    <li>
                        <p>Grab a slice of happiness with our pizza offer today!</p>
                    </li>
                    <li>
                        <p>Only from 10am to 2pm</p>
                    </li>
                    <li>
                        <p>Only delivery</p>
                    </li>
        ...
        <div class="promotions-item">
            <div class="content-box">
                <img src="../assets/images/coke3.webp" alt="">
            </div>
            ...
            <div class="description">
                ...
                <ul>
                    <li>
                        <p>Free Coke when total bill more than 999/-</p>
                    </li>
                    <li>
                        <p>From 08/05/2023 to 18/05/2023</p>
                    </li>
                    <li>
                        <p>Only online payment method</p>
                    </li>
