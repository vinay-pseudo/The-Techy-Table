<template>
  ...
  <div class="menu-section">
    <div class="row box-container">
      <div v-for="(f, index) in recommendedItems" :key="index">
        <div class="box">
      ...
      <div class="col-sm-8">
        <div class="row">
          <div class="menu-tabs">
            ...
            <input
              type="button"
              id="pizzaFilterFoodBtn"
              name="pizzaFilterFoodBtn"
              class="menu-tab-item"
              value="pizza"
              @click="filterFoodBtn($event)"
            />
            <input
              type="button"
              id="biryaniFilterFoodBtn"
              name="biryaniFilterFoodBtn"
              class="menu-tab-item"
              value="biryani"
              @click="filterFoodBtn($event)"
            />
            <input
              type="button"
              id="dosaFilterFoodBtn"
              name="dosaFilterFoodBtn"
              class="menu-tab-item"
              value="dosa"
              @click="filterFoodBtn($event)"
            />
            <input
              type="button"
              id="maincourseFilterFoodBtn"
              name="maincourseFilterFoodBtn"
              class="menu-tab-item"
              value="maincourse"
              @click="filterFoodBtn($event)"
            />
...
export default {
  ...
  computed: {
    ...mapState(["allFoods"]),
    ...mapState(["recommendedFoods"]),

    filterSelectedFoods: function () {
      return this.recommendedFoods.filter(
        (f) =>
    ...
    recommendedItems: function () {
      return this.filterSelectedFoods.slice(
  ...
  methods: {
    ...
    evaluatePrice: function (food, priceRange) {
      ...
      } else if (priceRange == "199,249") {
        if (199 <= cal && cal <= 249) {
          return food;
        }
      } else if (priceRange == "249,299") {
        if (249 <= cal && cal <= 299) {
          return food;
        }
