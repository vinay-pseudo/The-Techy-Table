<template>
  <div>
    <div class="home-main">
      <div class="content">
        <span>Get ready to be wowed!</span>
        <h3>Dine smarter, not harder. 😋</h3>
      ...
      <div class="image">
        <img src="../assets/images/thali4.png" alt="" class="home-img" />
        <!-- <img src="../assets/images/" alt="" class="home-parallax-img"> -->
      </div>
    </div>

    <div class="home-category">
      <router-link @click="scrollToTop()" to="/menu" class="box">
        <img src="../assets/images/pizzaicon.jpeg" alt="" />
        <h3>pizza</h3>
      </router-link>

      <router-link @click="scrollToTop()" to="/menu" class="box">
        <img src="../assets/images/paneericon.png" alt="" />
        <h3>main course</h3>
      </router-link>

      <router-link @click="scrollToTop()" to="/menu" class="box">
        <img src="../assets/images/biryaniicon.jpg" alt="" />
        <h3>biryani</h3>
      </router-link>

      <router-link @click="scrollToTop()" to="/menu" class="box">
        <img src="../assets/images/dosaicon.png" alt="" />
        <h3>south indian</h3>
      </router-link>
    ...
    <div class="home-about">
      ...
      <div class="content">
        ...
        <p>
          With years of experience in traditional Indian
          cooking techniques, our chef creates flavorful and authentic dishes
          that transport diners to the streets of India. Their knowledge of
          spices and ingredients is unparalleled, and they are dedicated to
          ensuring that each dish is prepared with precision and care. Our
          chef's creativity and expertise ensure that our menu offers a range of
          options that are both delicious and unique. We are confident that you
          will love the incredible dishes our chef creates and that you will
          leave our restaurant feeling satisfied and happy.
        </p>
